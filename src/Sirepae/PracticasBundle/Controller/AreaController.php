...
use Sirepae\PracticasBundle\Entity\Area;
use Sirepae\PracticasBundle\Form\AreaType;
...
class AreaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SirepaePracticasBundle:Area')->findAll();

        return array(
            'entities' => $entities,
            'active_areas_resumen'  =>  true
        );
    }
    /**
     ...
     * @Method("POST")
     * @Template("SirepaePracticasBundle:Area:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SirepaePracticasBundle:Area')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("SirepaePracticasBundle:Area:edit.html.twig")
     */
