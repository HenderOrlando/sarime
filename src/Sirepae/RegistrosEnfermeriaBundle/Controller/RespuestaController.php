...
use Sirepae\RegistrosEnfermeriaBundle\Entity\Respuesta;
use Sirepae\RegistrosEnfermeriaBundle\Form\RespuestaType;
...
class RespuestaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SirepaeRegistrosEnfermeriaBundle:Respuesta')->findAll();
     ...
     * @Method("POST")
     * @Template("SirepaeRegistrosEnfermeriaBundle:Respuesta:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SirepaeRegistrosEnfermeriaBundle:Respuesta')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("SirepaeRegistrosEnfermeriaBundle:Respuesta:edit.html.twig")
     */
